...
Self-contained Swift scripts that render the menu bar mascots and marks as
transparent PNGs (plus preview GIFs and System-mode simulations).
...
The Qwen and OpenCode marks are original artwork drawn for AgentBar and ship
pre-baked in `Sources/AgentBar/Sprites/QwenOpenCodeMarks.swift` — they have no
generator here. The earlier original-character concepts live in
